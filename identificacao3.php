...
<form action="" method="POST">
    <div class="col-lg-6"><b>Já tem cadastro?<br/> Acesse com seu e-mail e senha</b><br/>
        <p>&nbsp;</p>
        ...
        <p style="text-align: right"><a href="">Esqueci minha senha >></a></p>


    </div>
    <div class="col-lg-6" style="border-left: 1px black dotted">
        <b>Não tem cadastro?<br/> Faça aqui o seu.</b><br/>
        <p>&nbsp;</p>
